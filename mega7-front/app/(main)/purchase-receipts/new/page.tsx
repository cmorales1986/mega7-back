...
export default function Page() {
  ...
  async function onSave() {
    ...
    Swal.fire("OK", "Recepción creada y stock actualizado (costo neto, sin IVA).", "success");
  ...
  return (
    <PageShell
      ...
      subtitle="Recepción desde OC. Lote/serial si corresponde."
      right={
    ...
    >
      <HeaderCard
        openPOs={pr.openPOs}
        draft={pr.draft}
        onSelectPO={pr.selectPurchaseOrder}
        onChange={pr.setDraftPatch}
      />
      ...
      <LinesEditor
        draft={pr.draft}
        productMap={pr.productMap}
        onLineChange={pr.setLine}
      />
